...
## WARNING:
Configs and theming have been fixed and modularized. Installers are still WIP. For now, you can install individual packages using [GNU stow](https://www.gnu.org/software/stow/)
